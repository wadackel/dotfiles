---
name: rust-reviewer
description: Rust language specialist. Use for code changes touching .rs files. Focuses on ownership / borrow correctness, unsafe justification, Send/Sync boundaries, lifetime annotations, error propagation via Result, and async runtime patterns. Auto-dispatched by /gate when Rust files are detected.
